...
/**
 * Note: Some functions & variables are written inside the Render function because it won't get called outside,
 *  Its by design !!!! DONOT ALTER !!!!!
 */
export default class GeneralDonation extends React.Component {
  constructor(props) {
    super(props);
  ...
  getExchangeRates = (paymentMode) => {
    ...
    fetch(
      ...
      .then((resJson) => {
        ...
        let money = this.props.arr[this.props.index]["amounts"][currencyType];

        // maxLimit1 =
        //   7000 -
        //   7000 *
        //     this.props.arr[this.props.index]["transactionFee"][paymentMode];
  ...
  razorPay = () => {
    ...
    if (this.state.customAmountRadio) {
      ...
      //console.log(this.state.customAmount, transactionFee, amount);
    } else {
      amount = (
  ...
  //On paypalWebiew Navigation change, handles success, failure and splits the url for transactionId.
  //Don't touch
  ...
  //the postPending function calls the global paymentHandle in app.js
  ...
  render() {
    ...
    //console.log(ex);
    //console.log(this.state.totalPicker, ex, maxLimit);
      ...
      <React.Fragment>
        ...
        >
          ...
          >
            ...
            {this.state.moneyArr.length > 0
              ? this.state.moneyArr.map((item, index) => (
                  <View //.......................................Installment
                    key={index.toString()}
                    style={{
                      width: "100%",
                    ...
                    if (Number(this.state.money)) {
                      if (
                        ...
                        if (this.state.paymentMode == "paypal") {
                          ...
                          // console.log(apiUrl + "razorpay" + url);
                          ...
                          let url = `${apiUrl}razorpay/browser?email=${
                            ...
                            this.state.customAmountRadio
                              ...
                              : Number(Number(this.state.money).toFixed(2))
                          }&transactionAmount=${amount1}&perMonthAmount=${
                            this.state.customAmountRadio
                              ? Number(
                                  Number(this.state.customAmount).toFixed(2)
                                )
            ...
            >
              <View style={{ flex: 1 }}>
                ...
                >
                  ...
                  >
                    {this.state.money
                      ? this.state.exchangeRate["rates"][this.state.totalPicker]
                        ? (
                            Number(this.state.money) *
                              this.state.exchangeRate["rates"][
                                this.state.totalPicker
