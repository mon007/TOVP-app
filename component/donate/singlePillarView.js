...
export default class SinglePillarView extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <React.Fragment>
        ...
        >
                        ...
                        if (this.state.paymentMode == "paypal") {
                          if (Platform.OS == "ios") {
                            let url = `${apiUrl}paypal?email=${
                              ...
                              this.props.userId
                            }&offsetInHours=${new Date().getTimezoneOffset() /
                              60}&payInFull=${
                              this.state.customAmountRadio
                                ? true
                                : this.state.installment - 1 == 0
          ...
          >
            <Image
              source={require("../../src/tovp-pillars.jpg")}
              style={{
                width: "100%",
                height: "100%",
                borderRadius: 8,
          ...
          >
            ...
            >
              U.S. PAYMENTS BY CHECK & WIRE TRANSFER: To make payments in the
              U.S. by check go ​to Donation Details page. To make payments by
              bank wire transfer ​​go to Bank Transfer Details page.
            </Text>
          </View>
          <View //..................note
            style={[
          ...
          >
            ...
            >
              PLEASE NOTE: Although pillars are sponsored on a first come,
              first-served basis, due to the worldwide range of our fundraising
              through individual communication, high traffic volume from donors
              on the website, and a limited number of pillars, we cannot
              guarantee 100% that the pillar you select will be available due to
              lag time in all sponsorship reporting. We will make all efforts to
              offer you the pillar of your choice, but if the pillar you
              selected is already sponsored we will contact you to make another
              selection. We sincerely apologize for any inconvenience in that
              regard.
            </Text>
          </View>
