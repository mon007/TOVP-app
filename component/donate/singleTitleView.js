...
export default class SingleTitleView extends React.Component {
  constructor(props) {
    super(props);
  ...
  getExchangeRates = () => {
    ...
    fetch(
      ...
      .then((resJson) => {
        ...
        // let productTotalAmount = Number(
        //   this.props.arr[this.props.index]["amount"]
        // );
        // maxLimit1 =
        //   7000 -
        //   7000 *
            ...
            >
              ...
              >
                {this.state.customAmountRadio ? (
                  ...
                  >
                    <Text>{this.state.priceToBrick} Tiles</Text>
                  </View>
                ) : Platform.OS === "android" ? (
                  <Picker
